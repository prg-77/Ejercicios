...
# Parámetros
# ========================================
file_in = "pendulo_doble.dat" # Nombre del fichero de datos
file_out = "pendulo_doble" # Nombre del fichero de salida (sin extensión)
...
# Añade una línea que une las dos bolas
x1, y1 = 100, 100
x2, y2 = 105, 105
line, = ax.plot([x1, x2], [y1, y2], "-", color="red")
line2, = ax.plot([0, x1], [0, y1], "-", color="red", alpha=1)
...
def update(j_frame, frames_data, planet_points, planet_trails, show_trail):
    # Actualiza la posición de la línea que une las dos bolas
